...
class StylizationIntervention(ImageIntervention):
    """
    Implements stylization interventions by transforming an image into one of
    several distinct, less realistic artistic styles.
    """
    ...
    def _get_style_prompts(self, filter_description: str, sensitivity: Optional[int] = None) -> Dict[str, str]:
        ...
        cubism = (
            ...
            f"SPECIAL FOCUS:\n"
            f"- Elements matching '{filter_description}' should be {hard} fragmented into the smallest planes and least realistic forms, "
            "while remaining integrated into the composition.\n"
        )
